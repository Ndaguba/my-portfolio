                        ...
                        <div className="section-content">
                            ...
                            <div className="constraint-grid">
                                <div className="constraint-card">
                                    ...
                                    <p>Users lost trust during silent latency and assumed the AI had failed. I introduced visible reasoning states to make processing transparent and preserve confidence during sensitive medical interactions.</p>
                                </div>
                                <div className="constraint-card">
                                    <h3>Avoiding Pure Automation</h3>
                                    <p>Automatically logging vague inputs created dangerous ambiguity in health records. I chose guided clarification over silent assumptions to protect data accuracy and user trust.</p>
                                </div>
                                <div className="constraint-card">
                                    <h3>Tone as a Safety Feature</h3>
                                    <p>Clinical accuracy alone was not enough. During physician reviews, cold medical language increased anxiety, so I designed for an empathetic “nurse partner” tone that balanced authority with reassurance.</p>
                                </div>
                            </div>
                        </div>
                    </section>
